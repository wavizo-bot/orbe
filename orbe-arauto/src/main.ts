...
// ==== Estado ====
let alunos: Map<string, Aluno> = new Map();
let cartoesCriados: Map<string, HTMLElement> = new Map();
...
function abrirModal(
  ...
  const textarea = document.getElementById("modal-mensagem") as HTMLTextAreaElement;
...
function renderizarCartoes(listaIDunico: string[]) {
...
async function inicializar() {
  ...
  document.getElementById("btn-colar")!.addEventListener("click", async () => {
    ...
    (document.getElementById("input-codigo") as HTMLInputElement).value = texto;
  });

  document
    .getElementById("btn-limpar")!
    .addEventListener("click", () => {
      (document.getElementById("input-codigo") as HTMLInputElement).value = "";
    });

  document
    .getElementById("btn-processar")!
    .addEventListener("click", async () => {
      const codigo = (document.getElementById("input-codigo") as HTMLInputElement)
        .value;
